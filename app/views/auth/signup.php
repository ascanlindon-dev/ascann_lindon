...
<body class="min-h-screen flex items-center justify-center" style="background: linear-gradient(135deg, #38ef7d 0%, #11998e 40%, #43cea2 70%, #60a5fa 100%);">
  ...
  <h2 class="text-2xl font-bold mb-4" style="background: linear-gradient(90deg, #38ef7d, #43cea2, #60a5fa, #e0f7fa); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-fill-color: transparent;">Sign Up</h2>
